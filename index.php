...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<nav class="main-header navbar navbar-expand navbar-default navbar-light">
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="http://localhost/At-Taqwasonton/" class="nav-link">Home</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
					<a href="?page=rekap_km" class="nav-link">Rekap Kas Musholla</a>
				</li>
				<li class="nav-item d-none d-sm-inline-block">
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			<!-- Brand Logo -->
			<a href="http://localhost/At-Taqwasonton/" class="brand-link">
				<img src="dist/img/Logo.png" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light"> Musholla At-Taqwa</span>
			</a>
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a href="http://localhost/At-Taqwasonton/" class="d-block">
							<?php echo $data_nama; ?>
						</a>
        ...
        ?>
						<li class="nav-item">
							<a href="http://localhost/At-Taqwasonton/" class="nav-link">
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Musholla At-Taqwa Tj.Barat Gg.Sonton Jakarta Selatan
			</div>
			Copyright &copy;
			<a target="_blank" href="https://www.facebook.com/musholla.sonton">
				<strong> DKM At-Taqwa</strong>
			</a>
			All rights reserved.
		</footer>
